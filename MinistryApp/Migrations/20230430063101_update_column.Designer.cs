...
namespace Ministry.Migrations
{
    ...
    [Migration("20230430063101_update_column")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinistryApp.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("DistrictsVMId")
                        .HasColumnType("int");

                    b.Property<int>("Division")
                        .HasColumnType("int");

                    b.Property<int?>("DivisionsVMId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("UnionsVMId")
                        .HasColumnType("int");

                    b.Property<int?>("UpazilasVMId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DistrictsVMId");

                    b.HasIndex("DivisionsVMId");
                    ...
                    b.HasIndex("UnionsVMId");

                    b.HasIndex("UpazilasVMId");
            ...
            modelBuilder.Entity("MinistryApp.Models.ApplicationUser", b =>
                {
                    b.HasOne("Ministry.Models.DistrictsVM", "DistrictsVM")
                        .WithMany()
                        .HasForeignKey("DistrictsVMId");

                    b.HasOne("Ministry.Models.DivisionsVM", "DivisionsVM")
                        .WithMany()
                        .HasForeignKey("DivisionsVMId");

                    b.HasOne("Ministry.Models.UnionsVM", "UnionsVM")
                        .WithMany()
                        .HasForeignKey("UnionsVMId");

                    b.HasOne("Ministry.Models.UpazilasVM", "UpazilasVM")
                        .WithMany()
                        .HasForeignKey("UpazilasVMId");

                    b.Navigation("DistrictsVM");

                    b.Navigation("DivisionsVM");

                    b.Navigation("UnionsVM");

                    b.Navigation("UpazilasVM");
                });
